...
insert into public.lobbies (
  ...
  ('20000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'Friday at Gordon', 'Use the court closest to the lifeguard station.', '2026-06-07T20:30:00+03:00', 'open', 'public', 'fixed', 4, 4, 'range', 'B', 'C+', null, 'everyone', 'balanced', true, true, 90, true, true, 'Fast but friendly match. Looking for one more active player.'),
  ('20000000-0000-4000-8000-000000000002', '00000000-0000-4000-8000-000000000003', '10000000-0000-4000-8000-000000000002', 'League morning rotations', null, '2026-06-06T08:00:00+03:00', 'completed', 'approval_required', 'fixed', 6, 6, 'range', 'A+', 'League', null, 'everyone', 'competitive', true, true, 90, false, true, 'Six-player rotations. Waitlist is open for approved players.'),
  ...
  ('20000000-0000-4000-8000-000000000004', '00000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000004', 'Sunrise challenge', 'Meet by the north court before the first round.', '2026-06-08T07:30:00+03:00', 'open', 'public', 'fixed', 4, 6, 'range', 'C-', 'B+', null, 'everyone', 'balanced', true, true, 90, false, true, 'Early regular game. Nevo is a joined player, not the host.'),
  ('20000000-0000-4000-8000-000000000005', '00000000-0000-4000-8000-000000000004', '10000000-0000-4000-8000-000000000005', 'Monday night', null, '2026-06-05T18:00:00+03:00', 'completed', 'public', 'flexible', 4, 8, 'exact', null, null, 'B+', 'everyone', 'casual', true, true, 90, false, false, 'Finished mock game used for history and recap states.')
on conflict (id) do update set
